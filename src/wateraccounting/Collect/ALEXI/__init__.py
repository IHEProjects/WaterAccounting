...
This package downloads ALEXI data from ``ftp.watools.unesco-ihe.org``.
Use the ALEXI.daily function to download and create weekly ALEXI images in Gtiff format.
